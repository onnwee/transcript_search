// SystemMonitor: checks API endpoints, lists Docker containers, streams logs.
  ...
  return (
    <div className="p-4 font-mono">
      ...
      <table className="w-full text-left border border-gray-300 mb-6">
        ...
        <tbody>
          {apiResults.map((res) => (
            <tr key={res.url} className="border-t border-gray-300">
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2">🐳 Docker Containers</h3>
      <table className="w-full text-left border border-gray-300 mb-6">
        <thead className="bg-gray-100">
          <tr>
        ...
        <tbody>
          {containers.map((c) => (
            <tr key={c.id || c.name} className="border-t border-gray-300">
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2">📡 Live Docker Logs</h3>
      <DockerLogStream />
